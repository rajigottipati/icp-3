# -*- coding: utf-8 -*-
"""NN-Assignment3.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1k0wrB0I0MdrTAKgceyuhaX-AttA7Dqf_
"""
...
class FulltimeEmployee(Employee):#FulltimeEmployee class with Employee as its parent class
    ...
    def getCompany(self):
        if self.c_name not in self.c_name:
            return ""
        return self.c_name
raj=FulltimeEmployee("RAJYALAKSHMI","GOTTIPATI",4000,"DEVELOPMENT","FACEBOOK")#FultimeEmployee object
